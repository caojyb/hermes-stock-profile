...
out1=$(/home/caojy/.hermes/profiles/stock/.venv/bin/python3 double_up_screener.py --min-score 50 --market-outlook --mode deep --industry-neutral --factor-process 2>&1); c1=$?
echo "$out1"
echo ""
echo "===== V1 翻倍扫描 (Top3参数, 写 double_up_scores) ====="
cd /home/caojy/.hermes/profiles/stock/scripts/cron || exit 2
out2=$(/home/caojy/.hermes/profiles/stock/.venv/bin/python3 scan_doubling_potential.py 2>&1); c2=$?
echo "$out2" | tail -25
echo ""
echo "===== double_up_scores 最新候选统计 ====="
/home/caojy/.hermes/profiles/stock/.venv/bin/python3 -c "
import sqlite3
c=sqlite3.connect('/home/caojy/.hermes/profiles/stock/stock-work/data/production/market_cache.db')
