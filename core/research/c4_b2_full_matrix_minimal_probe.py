#!/usr/bin/env python3
"""
c4_b2_full_matrix_minimal_probe.py — minimal probe: 1 variant × 1 fold × 3 horizons.
Writes artifact immediately on completion.
"""
...
def main():
    ...
    out = {
        "experiment": "trend_v1 × fold_001 × [5,10,20]",
        ...
        "strategy_rank_ic": res.strategy_rank_ic,
        "strategy_mean_excess": res.strategy_mean_excess,
        "strategy_hit_rate": res.strategy_hit_rate,
        "baseline_ic": res.baseline_ic,
        "baseline_mean_excess": res.baseline_mean_excess,
        "elapsed_seconds": round(time.time() - t0, 3),
    }
    out_path = ARTIFACT_DIR / 'c4_b2_full_matrix_minimal_probe.json'
