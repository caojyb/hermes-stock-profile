#!/usr/bin/env python3
"""
c4_b2_full_matrix_trace.py — instrumented runner to detect stall.
Read-only. Runs one variant × one fold × one horizon with timing.
"""
...
def main():
    ...
    print("folds ready:", len(folds), round(time.time()-t0, 3), flush=True)
