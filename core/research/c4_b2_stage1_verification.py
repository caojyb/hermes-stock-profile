#!/usr/bin/env python3
"""
c4_b2_stage1_verification.py — M9.1-C4-B2-E Stage 1 Bounded Rerun
====================================================================
Verify the minimal dependency-injection fix over the canonical runner path:
  trend_v1 × 1 fold × 3 horizons
"""
...
def main() -> Dict[str, Any]:
    fold = FoldDefinition(
        ...
        notes="C4-B2-E Stage 1 verification",
    )
    ...
    out_path = ARTIFACT_DIR / 'c4_b2_stage1_verification.json'
